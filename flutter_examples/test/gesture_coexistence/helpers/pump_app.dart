...
import 'package:flutter_examples/gesture_coexistence/app.dart';
...
/// Настраивает view и mount'ит [GestureCoexistenceApp].
///
/// Включает teardown, который восстанавливает дефолтные view-параметры —
/// иначе тесты «текут» друг в друга.
Future<void> pumpGestureApp(WidgetTester tester) async {
  ...
  await tester.pumpWidget(GestureCoexistenceApp());
