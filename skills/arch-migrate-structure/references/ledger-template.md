...
<!-- Леджер создаётся структурным скиллом последним шагом — само его
наличие значит, что проход завершён. Статус всегда «готова»: все
механически переносимые файлы разложены, остальные внесены в раздел
«Осталось разобрать». Завершённое состояние, даже когда в разделе ещё
есть файлы — их разбор это работа выделения, а не структуры. -->
